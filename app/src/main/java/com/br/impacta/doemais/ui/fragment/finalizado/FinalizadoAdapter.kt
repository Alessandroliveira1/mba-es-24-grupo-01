...
class FinalizadoAdapter(
    private val onClick: (Doacao, Boolean) -> Unit
) : PagingDataAdapter<Doacao, FinalizadoViewHolder>(ARTICLE_DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FinalizadoViewHolder =
        FinalizadoViewHolder(
    ...
    override fun onBindViewHolder(holder: FinalizadoViewHolder, position: Int) {
