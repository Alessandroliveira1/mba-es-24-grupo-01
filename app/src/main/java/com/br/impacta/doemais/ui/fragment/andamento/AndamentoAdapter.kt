...
class AndamentoAdapter(
    private val onClick: (Doacao, Boolean) -> Unit
) : PagingDataAdapter<Doacao, AndamentoViewHolder>(ARTICLE_DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AndamentoViewHolder =
        AndamentoViewHolder(
    ...
    override fun onBindViewHolder(holder: AndamentoViewHolder, position: Int) {
